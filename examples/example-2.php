...
<div class="examples">
  ...
  <div class="example">
    ...
    <article>
      ...
      <h2>Example 2: Grouping flash messages by type</h2>
...
?> 
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <fieldset>
        ...
        <div class="field">
          <label for="field3" class="required">This field is required</label>
